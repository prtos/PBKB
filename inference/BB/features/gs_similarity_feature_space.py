...
import numpy
from PBKB.inference.BB.features.gs_similarity_weights import compute_gs_similarity_weights
from PBKB.inference.BB.utils import transform_strings_to_integer_lists, get_n_grams
...
class GenericStringSimilarityFeatureSpace:
    ...
    def compute_weights(self, y_weights, y_length):
        ...
        position_matrix = self.gs_kernel.compute_position_matrix(max_length)
