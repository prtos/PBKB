...
cdef class SearchStatsBuilderMock(SearchStatsBuilder):
    cdef mock
    ...
    cdef void end_start_nodes(self):
        self.mock.end_start_nodes()

    cdef void add_iteration(self):
        self.mock.add_iteration()

    cdef void update_solution(self):
        self.mock.update_solution()

    cdef void end(self):
        self.mock.end()

    cdef bool is_time_or_n_iterations_expired(self):
        return self.mock.is_time_or_n_iterations_expired()