...
import numpy
from PBKB.inference.BB.inference.bound_calculator import OCRMinBoundCalculator, MaxBoundCalculator, PeptideMinBoundCalculator
from PBKB.inference.BB.inference.node_creator import NodeCreator
...
class BoundFactory:
    ...
    def _setup_n_grams(self, kernel):
        ...
        self.n_gram_real_values = kernel.element_wise_kernel(numpy.array(self.n_grams))
...
def get_gs_similarity_node_creator(alphabet, n, graph, graph_weights, y_length, gs_kernel):
    ...
    end_weights = numpy.zeros(graph_weights.shape)
